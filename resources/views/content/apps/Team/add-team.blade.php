    ...
    <div class="app-user-register">
        ...
        <div class="page-header">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div>
                    <h4>
                        <i class="ri-user-add-line me-2"></i>Tambah User Baru
                    </h4>
                    <p class="text-muted mb-0">Isi data user dan akun login dengan lengkap</p>
                </div>
            ...
            <div class="card form-card mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="form-text-muted">
                            <i class="ri-information-line me-1"></i>Minimal 8 karakter
                        </small>
                        @error('password')
                            <small class="text-danger d-block mt-1">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="mb-0">
                        ...
                        <small class="form-text-muted">
                            <i class="ri-information-line me-1"></i>Harus sama dengan password di atas
                        </small>
